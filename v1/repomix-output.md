...
examples/websocket-demo.html
package.json
prisma/migrations/20251118062654_language_submission_status_result_and_user/migration.sql
prisma/migrations/20251124054047_updated/migration.sql
...
# Install Docker CLI for wrangler to spawn containers
            ...
            examples:
              javascript:
                ...
                value:
                  ...
                  language_id: 63
              python:
                summary: Python with stdin
                value:
                  source_code: "name = input()\nprint(f'Hello, {name}!')"
                  language_id: 71
                  stdin: "Alice"
              cpp_with_limits:
                summary: C++ with custom limits
                value:
                  source_code: |
                    #include <iostream>
                    int main() {
...
## File: examples/websocket-demo.html
````html
<!DOCTYPE html>
<html lang="en">
<head>
...
````json
{
	...
	"scripts": {
		...
		"seed": "dotenv -e .dev.vars -- tsx prisma/seed.ts"
	},
	"devDependencies": {
...
## File: prisma/migrations/20251118062654_language_submission_status_result_and_user/migration.sql
````sql
-- CreateTable
CREATE TABLE "User" (
    "id" TEXT NOT NULL,
...
## File: prisma/migrations/20251124054047_updated/migration.sql
````sql
-- AlterTable
...
## File: src/controllers/LanguageController.ts
````typescript
...
## File: src/controllers/StatusController.ts
````typescript
...
## File: src/controllers/SubmissionController.ts
````typescript
...
## File: src/controllers/WebSocketController.ts
````typescript
...
## File: src/durableObjects/Sandbox.ts
````typescript
...
## File: src/durableObjects/SubmissionExecutor.ts
````typescript
...
## File: src/durableObjects/SubmissionWebSocket.ts
````typescript
...
## File: src/repositories/LanguageRepository.ts
````typescript
...
## File: src/repositories/StatusRepository.ts
````typescript
import { prisma } from "../lib/db";
...
## File: src/services/CallbackService.ts
````typescript
import { SubmissionRepository } from "../repositories/SubmissionRepository";
...
````typescript
/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1e43b89134ffd1ecdaf4aa92f7becddd)
// Runtime types generated with workerd@1.20251113.0 2025-11-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "SubmissionExecutor" | "SubmissionWebSocket";
	}
	interface Env {
		RATE_LIMITER: KVNamespace;
		DATABASE_URL: string;
		SANDBOX: DurableObjectNamespace<import("./src/index").Sandbox>;
		SUBMISSION_EXECUTOR: DurableObjectNamespace<import("./src/index").SubmissionExecutor>;
		SUBMISSION_WEBSOCKET: DurableObjectNamespace<import("./src/index").SubmissionWebSocket>;
...
````
{
	...
	"durable_objects": {
		"bindings": [
			...
			{
				"class_name": "SubmissionExecutor",
				"name": "SUBMISSION_EXECUTOR"
			},
			{
				"class_name": "SubmissionWebSocket",
		...
		"producers": [
			{
				...
				"queue": "submission-execution-queue"
			}
		],
		"consumers": [
			{
